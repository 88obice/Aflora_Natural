...
urlpatterns = [
    ...
    path('productos/<int:pk>/agregar-stock/', views.agregar_stock, name='agregar_stock'),
    ...
    path('newsletter/suscriptores/exportar/', views.exportar_suscriptores_csv, name='exportar_suscriptores'),
    ...
    path('cupones/nuevo/', views.cupon_crear, name='cupon_crear'),
    path('cupones/<int:pk>/editar/', views.cupon_editar, name='cupon_editar'),
    path('cupones/<int:pk>/toggle/', views.cupon_toggle, name='cupon_toggle'),
